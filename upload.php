...
if ($fileSize > MAXUPLOADSIZE) { // 3 MB (1 byte * 1024 * 1024 * 3 (for 3 MB))
...
$allowedTypes = [
           ...
           'application/macbinary'                                                     => 'bin' . $noexecution,
           'application/mac-binary'                                                    => 'bin' . $noexecution,
           'application/x-binary'                                                      => 'bin' . $noexecution,
           'application/x-macbinary'                                                   => 'bin' . $noexecution,
           'image/bmp'                                                                 => 'bmp',
           'image/x-bmp'                                                               => 'bmp',
           'image/x-bitmap'                                                            => 'bmp',
           'image/x-xbitmap'                                                           => 'bmp',
           ...
           'application/vnd.openxmlformats-officedocument.wordprocessingml.document'   => 'docx' . $noexecution,
           ...
           'application/pgp'                                                           => 'pgp',
           'application/x-httpd-php'                                                   => 'php' . $noexecution,
           'application/php'                                                           => 'php' . $noexecution,
           'application/x-php'                                                         => 'php' . $noexecution,
           'text/php'                                                                  => 'php' . $noexecution,
           'text/x-php'                                                                => 'php' . $noexecution,
           'application/x-httpd-php-source'                                            => 'php' . $noexecution,
           'image/png'                                                                 => 'png',
           'image/x-png'                                                               => 'png',
           'application/powerpoint'                                                    => 'ppt',
           'application/vnd.ms-powerpoint'                                             => 'ppt',
           'application/vnd.ms-office'                                                 => 'ppt',
           'application/msword'                                                        => 'doc' . $noexecution,
           'application/vnd.openxmlformats-officedocument.presentationml.presentation' => 'pptx' . $noexecution,
           ...
           'application/x-excel'                                                       => 'xls' . $noexecution,
